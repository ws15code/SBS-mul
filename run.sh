...
export SBS_LANGUAGES="MD SW AR"
export TRAIN_LANG="SW AR"
export TEST_LANG="MD"
...
#     2>&1 | tee data/$L/prepare_lang.log || exit 1;
# done

# for L in $SBS_LANGUAGES; do
#   echo "LM $L"
#   local/sbs_format_phnlm.sh $L 2>&1 | tee data/$L/format_lm.log || exit 1;
# done
# wait
